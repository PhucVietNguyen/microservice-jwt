package com.example.as.service.secutiry.oauth2;
...
import com.example.as.service.secutiry.oauth2.user.OAuth2UserInfo;
import com.example.as.service.secutiry.oauth2.user.OAuth2UserInfoFactory;
import com.example.common.core.utils.StringUtil;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
  ...
  private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
    ...
    if (StringUtil.isEmptyString(oAuth2UserInfo.getEmail())) {
