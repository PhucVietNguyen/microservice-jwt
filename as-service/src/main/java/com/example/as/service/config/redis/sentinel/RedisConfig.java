package com.example.as.service.config.redis.sentinel;

import com.example.as.service.config.redis.sentinel.RedisProperties.SentinelNode;
...
public class RedisConfig extends CachingConfigurerSupport {
  ...
  RedisSentinelConfiguration sentinelConfig() {
    ...
    var sentinels = redisProperties.getSentinels().stream().map(getSentinelNodeRedisNodeFunction())
